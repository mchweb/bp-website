...
function showPopup(x, type, extra){
  switch (x) {
    ...
    case 9:
      ...
      break
    case 10:
      _showPopup('eventReg', type, 'Связаться с организаторами', 'Чтобы не ждать, прямо сейчас позвоните по телефону <a href="tel:+73822933976">(3822) 933-976</a> и получите необходимую информацию. Либо задайте вопрос через эту форму (не забудьте указать контактную информацию (телефон, электронная почта, социальные сети), <strong>чтобы мы могли в кратчайшие сроки вам ответить</strong>)');
      break
    default:
      break
  }
